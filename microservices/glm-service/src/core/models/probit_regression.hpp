...
class ProbitRegression : public GLMBase {
public:
    ProbitRegression() = default;
...
protected:
    ...
    double linkFunction(double p) const override;
    double linkDerivative(double p) const override;
...
private:
    ...
    double normalQuantile(double p) const;
};
